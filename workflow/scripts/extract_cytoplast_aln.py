    ...
    for line in sample_files:
        ...
        for sample_contig in sample_contigs:
            ...
            for pileup_pos in bam_pileup:
                ...
                # if counter == 1000:
                #     break
                if last_pos != pileup_pos.reference_pos - 1:
                    if last_pos != -1:
                        # if part of the reference was skipped
                        aln_string += "N" * (pileup_pos.reference_pos - last_pos + 1)
                last_pos = pileup_pos.reference_pos
